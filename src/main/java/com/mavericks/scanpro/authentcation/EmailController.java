...
import com.mavericks.scanpro.requests.EmailDataRequest;
...
public class EmailController {
    ...
    public ResponseEntity<?> verifyEmail(@RequestParam("token") String token) {
        ...
        if (user != null) {
            ...
            EmailDataRequest datareq = new EmailDataRequest(user.getFullname(),user.getEmail());
            return ResponseEntity.ok(datareq);
